...
<form action="<?= BASE ?>/reservations/availability" method="GET" class="form-card">
    <div class="form-row">
            ...
            <tbody>
                <?php foreach ($tables as $table): ?>
                    <tr>
                        ...
                        <td><a href="<?= BASE ?>/reservations/create?id_table=<?= $table['id_table'] ?>&date=<?= urlencode($date) ?>&time=<?= urlencode($time) ?>" class="btn btn-small btn-success">Book</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
